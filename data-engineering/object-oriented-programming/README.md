...
- `@dataclass(frozen = True)` prevents any attributes inside the class definition from being modified
- Useful when you know the data inside the class isn't going to change
