...
- z-statistic
  ...
  - z large -> <a href="https://www.codecogs.com/eqnedit.php?latex=\inline&space;\text{coefficient}&space;\neq&space;0" target="_blank"><img src="https://latex.codecogs.com/svg.latex?\inline&space;\text{coefficient}&space;\neq&space;0" title="\text{coefficient} \neq 0" /></a> -> variable significant
